...
namespace CasDotnetSdk.Hybrid
{
    ...
    public class HybridEncryptionWrapper
    {
        ...
        public void HybridEncryption(AESRSAHybridInitializer intializer)
        {
            AESRSAHybridInitializerStruct strut = new AESRSAHybridInitializerStruct();
            strut.aesType = intializer.AesType;
            strut.rsaType = intializer.RsaType;
            HybridEncryptionWindowsWrapper.hybrid_encryption(strut);
        }
